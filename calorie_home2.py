...
st.markdown("""
    <style>
    .stApp {
        background-image: url('https://cdn.mos.cms.futurecdn.net/9aBvQFhJeqkxZwuFU2TSyd-970-80.jpg.webp');
...
st.markdown("""
	...
	<div style="background-color: rgba(0,0,0,0.5); padding: 20px; border-radius>
...
<div style="text-align:center">
    <div style="background-color: rgba(0,0,0,0.5); padding: 20px; border-radius>
    <h2>📊 Summary</h2>
    <p><b>Quarter:</b> Q2 2025 (Apr 1 – Jun 30)</p>
</div>
""", unsafe_allow_html=True)

st.markdown(f"""
<div style="background-color: rgba(0,0,0,0.5); padding: 20px; border-radius: 10px; text-align:center; font-size:18px;">
    <p><b>Total Calories In:</b> {int(total_in)} kcal</p>
    <p><b>Total Calories Burned:</b> {int(total_burned)} kcal</p>
    <p><b>Net Calories:</b> {int(total_in - total_burned)} kcal</p>
</div>
""", unsafe_allow_html=True)
